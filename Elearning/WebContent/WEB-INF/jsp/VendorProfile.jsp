...
<h1 class="title">Vendor Profile</h1>

<%
User user=(User)session.getAttribute("user");
%>
<form style="text-align:left;width:500px;margin:auto;" method="post" action="UpdateProfile">
	<label class="label" for="name">Name</label>
	<input type="text" class="controls" name="name"  readonly style="background-color:lightgrey" id="name" value="<%= user.getName() %>"><br>
	...
	<input type="text" class="controls" name="phone" maxlength="10" id="phone" value="<%= user.getPhone() %>"><br>
